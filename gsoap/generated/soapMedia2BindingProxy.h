...
#include "soapH.h"
    ...
    class SOAP_CMAC Media2BindingProxy {
      public:
        ...
        //
        /// Web service synchronous operation 'GetWebRTCConfigurations' with default endpoint and default SOAP Action header, returns SOAP_OK or error code
        virtual int GetWebRTCConfigurations(_ns1__GetWebRTCConfigurations *ns1__GetWebRTCConfigurations, _ns1__GetWebRTCConfigurationsResponse &ns1__GetWebRTCConfigurationsResponse) { return this->GetWebRTCConfigurations(NULL, NULL, ns1__GetWebRTCConfigurations, ns1__GetWebRTCConfigurationsResponse); }
        /// Web service synchronous operation 'GetWebRTCConfigurations' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int GetWebRTCConfigurations(const char *soap_endpoint_url, const char *soap_action, _ns1__GetWebRTCConfigurations *ns1__GetWebRTCConfigurations, _ns1__GetWebRTCConfigurationsResponse &ns1__GetWebRTCConfigurationsResponse) { return this->send_GetWebRTCConfigurations(soap_endpoint_url, soap_action, ns1__GetWebRTCConfigurations) || this->recv_GetWebRTCConfigurations(ns1__GetWebRTCConfigurationsResponse) ? this->soap->error : SOAP_OK; }
        /// Web service asynchronous operation 'send_GetWebRTCConfigurations' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int send_GetWebRTCConfigurations(const char *soap_endpoint_url, const char *soap_action, _ns1__GetWebRTCConfigurations *ns1__GetWebRTCConfigurations);
        /// Web service asynchronous operation 'recv_GetWebRTCConfigurations' to receive a response message from the connected endpoint, returns SOAP_OK or error code
        virtual int recv_GetWebRTCConfigurations(_ns1__GetWebRTCConfigurationsResponse &ns1__GetWebRTCConfigurationsResponse);
        //
        /// Web service synchronous operation 'SetWebRTCConfigurations' with default endpoint and default SOAP Action header, returns SOAP_OK or error code
        virtual int SetWebRTCConfigurations(_ns1__SetWebRTCConfigurations *ns1__SetWebRTCConfigurations, _ns1__SetWebRTCConfigurationsResponse &ns1__SetWebRTCConfigurationsResponse) { return this->SetWebRTCConfigurations(NULL, NULL, ns1__SetWebRTCConfigurations, ns1__SetWebRTCConfigurationsResponse); }
        /// Web service synchronous operation 'SetWebRTCConfigurations' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int SetWebRTCConfigurations(const char *soap_endpoint_url, const char *soap_action, _ns1__SetWebRTCConfigurations *ns1__SetWebRTCConfigurations, _ns1__SetWebRTCConfigurationsResponse &ns1__SetWebRTCConfigurationsResponse) { return this->send_SetWebRTCConfigurations(soap_endpoint_url, soap_action, ns1__SetWebRTCConfigurations) || this->recv_SetWebRTCConfigurations(ns1__SetWebRTCConfigurationsResponse) ? this->soap->error : SOAP_OK; }
        /// Web service asynchronous operation 'send_SetWebRTCConfigurations' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
