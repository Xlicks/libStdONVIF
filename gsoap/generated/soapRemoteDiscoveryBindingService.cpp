...
int RemoteDiscoveryBindingService::dispatch(struct soap* soap)
{
	...
	if (soap->action)
	{
		if (!strcmp(soap->action, "http://www.onvif.org/ver10/network/wsdl/Bye"))
			return serve___tdn__Bye(soap, this);
		if (!strcmp(soap->action, "http://www.onvif.org/ver10/network/wsdl/Hello"))
			return serve___tdn__Hello(soap, this);
		if (!strcmp(soap->action, "http://www.onvif.org/ver10/network/wsdl/Probe"))
