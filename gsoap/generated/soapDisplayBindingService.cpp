...
#ifndef WITH_NOIO
int DisplayBindingService::run(int port, int backlog)
...
int DisplayBindingService::ssl_run(int port, int backlog)
{	if (!soap_valid_socket(this->soap->master) && !soap_valid_socket(this->bind(NULL, port, backlog)))
		return this->soap->error;
	for (;;)
	{	if (!soap_valid_socket(this->accept()))
...
int DisplayBindingService::dispatch(struct soap* soap)
{
	...
	if (soap->action)
	{
		const char *soap_action[] = { "http://www.onvif.org/ver10/display/wsdl/CreatePaneConfiguration", "http://www.onvif.org/ver10/display/wsdl/DeletePaneConfiguration", "http://www.onvif.org/ver10/display/wsdl/GetDisplayOptions", "http://www.onvif.org/ver10/display/wsdl/GetLayout", "http://www.onvif.org/ver10/display/wsdl/GetPaneConfiguration", "http://www.onvif.org/ver10/display/wsdl/GetPaneConfigurations", "http://www.onvif.org/ver10/display/wsdl/GetServiceCapabilities", "http://www.onvif.org/ver10/display/wsdl/SetLayout", "http://www.onvif.org/ver10/display/wsdl/SetPaneConfiguration", "http://www.onvif.org/ver10/display/wsdl/SetPaneConfigurations",  };
		switch (soap_binary_search_string(soap_action, 10, soap->action))
		{
			case 0:	
