...
#ifndef WITH_NOIO
int SearchBindingService::run(int port, int backlog)
...
int SearchBindingService::ssl_run(int port, int backlog)
{	if (!soap_valid_socket(this->soap->master) && !soap_valid_socket(this->bind(NULL, port, backlog)))
		return this->soap->error;
	for (;;)
	{	if (!soap_valid_socket(this->accept()))
...
int SearchBindingService::dispatch(struct soap* soap)
{
	...
	if (soap->action)
	{
		const char *soap_action[] = { "http://www.onvif.org/ver10/search/wsdl/EndSearch", "http://www.onvif.org/ver10/search/wsdl/FindEvents", "http://www.onvif.org/ver10/search/wsdl/FindMetadata", "http://www.onvif.org/ver10/search/wsdl/FindPTZPosition", "http://www.onvif.org/ver10/search/wsdl/FindRecordings", "http://www.onvif.org/ver10/search/wsdl/GetEventSearchResults", "http://www.onvif.org/ver10/search/wsdl/GetMediaAttributes", "http://www.onvif.org/ver10/search/wsdl/GetMetadataSearchResults", "http://www.onvif.org/ver10/search/wsdl/GetPTZPositionSearchResults", "http://www.onvif.org/ver10/search/wsdl/GetRecordingInformation", "http://www.onvif.org/ver10/search/wsdl/GetRecordingSearchResults", "http://www.onvif.org/ver10/search/wsdl/GetRecordingSummary", "http://www.onvif.org/ver10/search/wsdl/GetSearchState", "http://www.onvif.org/ver10/search/wsdl/GetServiceCapabilities",  };
